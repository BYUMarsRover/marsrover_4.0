...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name, 'models/hanksville_terrain'),
            glob('models/hanksville_terrain/*')),
        (os.path.join('share', package_name, 'models/provo_canyon_terrain'),
            glob('models/provo_canyon_terrain/*')),
        (os.path.join('share', package_name, 'models/custom_terrain'),
            glob('models/custom_terrain/model*')),
        (os.path.join('share', package_name, 'models/custom_terrain/materials/textures'),
            glob('models/custom_terrain/materials/textures/*')),
    ],
