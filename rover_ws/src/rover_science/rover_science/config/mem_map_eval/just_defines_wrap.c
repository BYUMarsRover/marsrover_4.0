...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__just

#else
#  define SWIG_init    init_just
...
# endif
  ...
  SWIG_Python_SetConstant(d, "EEPROM_SIZE",SWIG_From_int((int)(0x0400)));
  SWIG_Python_SetConstant(d, "MAX_EEPROM_ADDR",SWIG_From_int((int)((0x0400-1))));
  SWIG_Python_SetConstant(d, "EEPROM_CONFIG_START_ADDR",SWIG_From_int((int)(0x0000)));
  SWIG_Python_SetConstant(d, "EEPROM_UV_SENSITIVTY_ADDR",SWIG_From_int((int)(0x0000)));
  SWIG_Python_SetConstant(d, "EEPROM_ACTUATOR_EXTEND_RETRACT_TIME_TABLE_ADDR",SWIG_From_int((int)(0x0002)));
  SWIG_Python_SetConstant(d, "EEPROM_ROUTINE_LOOKUP_TABLE_SIZE_ADDR",SWIG_From_int((int)(0x002A)));
  SWIG_Python_SetConstant(d, "EEPROM_ROUTINE_LOOKUP_TABLE_ADDR",SWIG_From_int((int)(0x002B)));
  SWIG_Python_SetConstant(d, "NUM_COEFFS",SWIG_From_int((int)(10)));
  SWIG_Python_SetConstant(d, "SIZE_OF_COEFF",SWIG_From_int((int)(4)));
  SWIG_Python_SetConstant(d, "COEFF_ARRAY_SIZE",SWIG_From_int((int)((10*4))));
  SWIG_Python_SetConstant(d, "EEPROM_PTR_HUM_COEFF_ARRAY",SWIG_From_int((int)((0x0400-(10*4)))));
  SWIG_Python_SetConstant(d, "EEPROM_PTR_HUM_COEFF_COUNT",SWIG_From_int((int)(((0x0400-(10*4))-1))));
  SWIG_Python_SetConstant(d, "EEPROM_PTR_TEMP_COEFF_ARRAY",SWIG_From_int((int)((((0x0400-(10*4))-1)-(10*4)))));
  SWIG_Python_SetConstant(d, "EEPROM_PTR_TEMP_COEFF_COUNT",SWIG_From_int((int)(((((0x0400-(10*4))-1)-(10*4))-1))));
  SWIG_Python_SetConstant(d, "NUM_CALIBRATION_PTS",SWIG_From_int((int)(40)));
  SWIG_Python_SetConstant(d, "SIZE_OF_CAL_PT",SWIG_From_int((int)(6)));
  SWIG_Python_SetConstant(d, "CURVE_ARRAY_SIZE",SWIG_From_int((int)((40*6))));
  SWIG_Python_SetConstant(d, "EEPROM_TEMP_CAL_PTS_COUNT",SWIG_From_int((int)(((0x0400-1)-(10*4)))));
  SWIG_Python_SetConstant(d, "EEPROM_TEMP_CAL_PTS_ARRAY",SWIG_From_int((int)((((((0x0400-(10*4))-1)-(10*4))-1)+1))));
  SWIG_Python_SetConstant(d, "EEPROM_HUM_CAL_PTS_COUNT",SWIG_From_int((int)(((((((0x0400-(10*4))-1)-(10*4))-1)-1)-(10*4)))));
  SWIG_Python_SetConstant(d, "EEPROM_HUM_CAL_PTS_ARRAY",SWIG_From_int((int)((((0x0400-(10*4))-1)+1))));
#if PY_VERSION_HEX >= 0x03000000
  return m;
#else
  return;
