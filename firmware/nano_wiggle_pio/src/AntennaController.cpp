...
#define SWITCH_PIN 4          // Switch pin
#define LED_PIN 13            // LED pin (Note: not PWM-capable)
#define BUTTON_PIN 2          // Button Pin
#define SERVO_PIN 9           // Servo pin
#define SWITCH_SAMPLE_PIN 11  // Was 6 before, switched on pcb
#define BATTERY_PIN A0        // Battery sample pin I THINK ----

// Battery monitoring parameters
#define DIVIDER_RATIO 2.0f         // Voltage divider ratio (e.g., 2.0 for 1:1 divider)
#define BATTERY_LOW_THRESHOLD 4.4f // Voltage threshold for low battery
